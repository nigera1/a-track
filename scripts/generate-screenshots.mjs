...
(async () => {
    ...
    for (const p of pages) {
        ...
        await page.screenshot({ path: `C:\\Users\\geran\\.gemini\\antigravity\\brain\\fd3700ec-351a-4b6d-9316-1a393c804128\\${p.name}_example.png` });
    }

    console.log('Taking screenshot for Invoice...');
    try {
        ...
        if (orderLink) {
            ...
            await page.screenshot({ path: `C:\\Users\\geran\\.gemini\\antigravity\\brain\\fd3700ec-351a-4b6d-9316-1a393c804128\\order_detail_example.png` });
            ...
            await page.screenshot({ path: `C:\\Users\\geran\\.gemini\\antigravity\\brain\\fd3700ec-351a-4b6d-9316-1a393c804128\\invoice_example_screen.png`, fullPage: true });
        }
    } catch(err) {
